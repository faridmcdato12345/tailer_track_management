            ...
            <nav class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink v-if="hasPermission('show yard admin user')" :href="route('users.index')"
                                    :active="route().current('users.index')">
                                    Users
                                </NavLink>
                                <NavLink v-if="hasPermission('show user')" :href="route('tractor.index')"
                                    :active="route().current('tractor.index')">
                                    Users
                                </NavLink>
                                <NavLink v-if="hasPermission('show user')" :href="route('track.index')"
                                    :active="route().current('track.index')">
                                    Track Tractor
                                </NavLink>
                                        ...
                                        <Dropdown align="right" width="48">
                                            ...
                                            <template #content>
                                                ...
                                                <div class="mt-3 px-4"
                                                    ...
                                                    <DropdownLink v-if="hasPermission('show yard')"
                                                        :href="route('motel.index')">
                                                        Yard
                                                    </DropdownLink>
                                                    <DropdownLink v-if="hasPermission('show yard')"
                ...
                <div :class="{ block: showingNavigationDropdown, hidden: !showingNavigationDropdown }"
                    ...
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink v-if="hasPermission('show yard')" :href="route('motel.index')"
